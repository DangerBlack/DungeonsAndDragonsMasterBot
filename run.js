...
function selStat(level,stat,possibile){
	possibile[stat]=level;
	return possibile;
}

function magicGet(lista,possibile){
	var ret = [];
	ret["value"] = possibile[lista];		
	ret["style"] = [];
	ret["style"]["display"] = null;
	return ret;
}

function run(level,gender) {
possibile = {
		}

possibile = selStat(level,"selLevel",possibile);
possibile = selStat(gender,"selGender",possibile);
console.log(possibile)
console.log(possibile["selLevel"])	
console.log(possibile["selGender"])
console.log("-------------------------starting--------------------------------");
			
if ((magicGet("genMethod",possibile).value == "2") || (magicGet("genMethod",possibile).value == "3")) {
	magicGet("buyDropdowns",possibile).style.display="inline";		
}

if (magicGet("genMethod",possibile).value == "3") {
...
if (magicGet("genMethod",possibile).value != "0") {
	magicGet("selAbil",possibile).style.display="none";		
}
if (magicGet("selClass",possibile).value == 15) {
	magicGet("wizardOptions",possibile).style.display="inline";		
}
if (magicGet("selClass",possibile).value == 3) {
	magicGet("clericOptions",possibile).style.display="inline";	
}
if (magicGet("selClass",possibile).value == 4) {
	magicGet("druidOptions",possibile).style.display="inline";		
}
if (magicGet("selClass",possibile).value == 1) {
	magicGet("barbarianOptions",possibile).style.display="inline";	
}
if (magicGet("selClass",possibile).value == 2) {
	magicGet("bardOptions",possibile).style.display="inline";	
}
if ((magicGet("selClass",possibile).value == 6) || (magicGet("selClass",possibile).value == 7)) {
	magicGet("fighterOptions",possibile).style.display="inline";	
}
if (magicGet("selClass",possibile).value == 8) {
	magicGet("monkOptions",possibile).style.display="inline";	
}
if (magicGet("selClass",possibile).value == 9) {
	magicGet("paladinOptions",possibile).style.display="inline";	
}
if (magicGet("selClass",possibile).value == 10) {
	magicGet("rangerOptions",possibile).style.display="inline";	
}
if (magicGet("selClass",possibile).value == 11) {
	magicGet("rogueOptions",possibile).style.display="inline";	
}
if (magicGet("selClass",possibile).value == 13) {
	magicGet("sorcererOptions",possibile).style.display="inline";	
}
if (magicGet("selClass",possibile).value == 14) {
	magicGet("warlockOptions",possibile).style.display="inline";	
}


var al=false;
if (magicGet("al",possibile).checked == true) 
	al=true;


var gender=-1;
var forceGender =0;
forceGender = magicGet("selGender",possibile).value * 1;

var forceCl =0;
forceCl = magicGet("selClass",possibile).value * 1;

var forceRace =0;
forceRace = magicGet("selRace",possibile).value * 1;

var forceBg =0;
forceBg = magicGet("selBg",possibile).value * 1;

var forceAbil =0;
forceAbil = magicGet("selAbil",possibile).value * 1;

var forceDomain =0;
forceDomain = magicGet("selCleric",possibile).value * 1;

var forceSchool =0;
forceSchool = magicGet("selWizard",possibile).value * 1;

var forceCircle =0;
forceCircle = magicGet("selDruid",possibile).value * 1;

var forceBarb = magicGet("selBarbarian",possibile).value * 1;
var forceBard =magicGet("selBard",possibile).value * 1;
var forceFigh =magicGet("selFighter",possibile).value * 1;
var forceMonk =magicGet("selMonk",possibile).value * 1;
var forcePala =magicGet("selPaladin",possibile).value * 1;
var forceRang =magicGet("selRanger",possibile).value * 1;
var forceRogu =magicGet("selRogue",possibile).value * 1;
var forceSorc =magicGet("selSorcerer",possibile).value * 1;
var forceWarl =magicGet("selWarlock",possibile).value * 1;
var forceWarlPact =magicGet("selWarlockPact",possibile).value * 1;
...
var platinum=0;
var forceLvl =0;
forceLvl = magicGet("selLevel",possibile).value * 1;

console.log("forceLvl: "+forceLvl);
...
//determine passive perception
	...
	output += "<b>Ability scores:</b>==EOF==<pre>STR:  " + digits(abil[0]) + " (" + showPlus( mod[0] ) + ")   DEX:  " + digits(abil[1]) + " (" + showPlus( mod[1] ) + ")   CON: " + digits(abil[2])  + " ("+ showPlus( mod[2] ) +
		")   ==EOF==INT:  " + digits(abil[3]) + " ("+showPlus ( mod[3] )+")   WIS:  " + digits(abil[4]) + " ("+showPlus ( mod[4] )+")   CHA: " + digits(abil[5]) + " ("+showPlus ( mod[5] )+
		")</pre>==EOF==<b>Saving throws:</b>==EOF==<pre>STR:  " + showPlus( saves[0] ) + "   DEX:  " + showPlus( saves[1] ) + "    CON: " +  showPlus( saves[2] ) + "   ==EOF==INT:  " + showPlus ( saves[3] )+"   WIS:  " + showPlus ( saves[4] )+"    CHA: " +showPlus ( saves[5] )+
		"==EOF==</pre><b>Initiative:</b>  " + showPlus( initiative ) + "   <b>Speed:</b>  " + speed;
		...
		output += "   <b>Passive perception:</b>  " + passive +"==EOF==<b>Size:</b>  " + size+"==EOF==<b>Proficiency bonus:</b>  " + showPlus(prof);

	if (gender==2) {
		output += "==EOF==<b>Gender:</b> Female ♀";
	} else {
		output += "==EOF==<b>Gender:</b>  Male ️♂";
	}
	output += "==EOF==";
}
...
if (magicGet("genMethod",possibile).value == "1") {
	abilRaw = [];
	x=Math.floor(Math.random() * allArrays.length);
	abilRaw = allArrays[x];
	console.log("Array picked = "+abilRaw);
	rollOutput += "Random array:  " + abilRaw;
} else if (magicGet("genMethod",possibile).value == "2") {
	abilRaw = [];
	abilRaw.unshift(magicGet("a1").value * 1);
	abilRaw.unshift(magicGet("a2").value * 1);
	abilRaw.unshift(magicGet("a3").value * 1);
	abilRaw.unshift(magicGet("a4").value * 1);
	abilRaw.unshift(magicGet("a5").value * 1);
	abilRaw.unshift(magicGet("a6").value * 1);
	abilRaw.sort(function(a,b){return b-a});
} else if (magicGet("genMethod",possibile).value == "3") {
	abil[0]=magicGet("a1").value * 1;
	abil[1]=magicGet("a2").value * 1;
	abil[2]=magicGet("a3").value * 1;
	abil[3]=magicGet("a4").value * 1;
	abil[4]=magicGet("a5").value * 1;
	abil[5]=magicGet("a6").value * 1;
	
} else {

	rollOutput += "<b>Proficient skills:</b>  ==EOF==";
	y=0;
	z=65;
	if (forceAbil > 0)
		z=forceAbil;
	...
	//rollOutput = "<i>Rolls: " + abilRaw + "=" +i + " total</i>";
	...
	case 1:
		...
		if (level >2) {
			...
			if (x < 0.5) {
				...
				classtxt += " (Path of the Totem Warrior - ";
...
//		abOutput += mod[5] + " uses)"
	...
	case 3:
		...
		if ((forceDomain > -1) && (magicGet("selClass",possibile).value == 3)) {
	...
	case 4:
		...
		xx = -1;
		if ((forceCircle > -1) && (magicGet("selClass",possibile).value == 4)) {
			xx = forceCircle;
		}
		...
		if (level > 1) {
			...
			if ((x < 0.5) || (xx > 0)) {
				...
				classtxt += " (Circle of the Land  - "+land+")";
...
//				temp = "Great Weapon Fighting"; doesn't work well for a finesse fighter
		...
		if (level > 2) {
			...
			switch (x) {
				case 0:
					...
					if (waPatron ==0) {
						if (Math.random() < 0.5)
							familiar = "Sprite - 2 hit points, 15 AC, <i>Heart Sight, Invisibility</i>, Longsword +2 to hit (1 dmg), Shortbow +6 to hit (1 dmg, check if poisoned) Range 40/160";
						else 
							familiar = "Pseudodragon - 7 hit points, 13 AC, <i>Keen Senses, Magic Resistance, Limited Telepathy</i>, Bite +4 to hit (1d4 +2 dmg), Sting +4 to hit (1d4 +2 dmg, check if poisoned)";
					}
					if (waPatron ==1) {
						if (Math.random() < 0.5)
							familiar = "Quasit - 7 hit points, 13 AC, <i>Shapechanger, Magic Resistance, Scare, Invisibility,</i> Claws +4 to hit (1d4+3 dmg, check if poisoned)";
						else 
							familiar = "Imp  - 10 hit points, 13 AC, <i>Shapechanger, Devil's Sight, Magic Resistance, Invisibility</i>, Sting +5 to hit (1d4 +3 dmg, check for 3d6 poison dmg)";
					}
					if (waPatron ==2) {
	...
	case 15:
		...
		if (level > 1) {
			...
			//alert(magicGet("selClass",possibile).value +"/"+forceSchool )
			if ((forceSchool > -1) && (magicGet("selClass",possibile).value == 15)) {
...
//d.baschieri from here

output += "" + name +  " - Level " + level + " " + racetxt + " " + classtxt + "==EOF==";
...
switch (bg) {
	...
	case(1):
		...
		bgText += "==EOF==<b>Ideal:</b> ";
		if (ideal==1)
			bgText += "Tradition. The ancient traditions of worship and sacrifice must be preserved and upheld. (Lawful)==EOF==";
		if (ideal==2)
			bgText += "Charity. I always try to help those in need, no matter what the personal cost. (Good)==EOF==";
		if (ideal==3)
			bgText += "Change. We must help bring about the changes the gods are constantly working in the world. (Chaotic)==EOF==";
		if (ideal==4)
			bgText += "Power. I hope to one day rise to the top of my faith’s religious hierarchy. (Lawful)==EOF==";
		if (ideal==5)
			bgText += "Faith. I trust that my deity will guide my actions, I have faith that if I work hard, things will go well. (Lawful)==EOF==";
		if (ideal==6)
			bgText += "Aspiration. I seek to prove myself worthy of my god’s favor by matching my actions against his or her teachings. (Any)==EOF==";
		
		
		bgText += "<b>Bond:</b>  ";
		if (bond==1)
			bgText += "I would die to recover an ancient relic of my faith that was lost long ago.==EOF==";
		if (bond==2)
			bgText += "I will someday get revenge on the corrupt temple hierarchy who branded me a heretic.==EOF==";
		if (bond==3)
			bgText += "I owe my life to the priest who took me in when my parents died.==EOF==";
		if (bond==4)
			bgText += "Everything I do is for the common people.==EOF==";
		if (bond==5)
			bgText += "I will do anything to protect the temple where I served.==EOF==";
		if (bond==6)
			bgText += "I seek to preserve a sacred text that my enemies consider heretical and seek to destroy.==EOF==";
...
for (x=0;x < 18;x++)		{
	...
	if (skLearn[x] == true) {
		...
		if (expertise.indexOf(x) == -1) {
			...
			skOutput +=  "" + skills[x] + " " + showPlus( (mod[skAbil[x]] + (prof*2)) ) + " (Expertise)";
		}
		first=true;
	}
...
if (burglar==true) 
	skOutput += ", Expert with Thieves' Tools"

first=false;
skOutput += "==EOF==<b>Non-proficient skills:</b>==EOF==";
...
if (cl==15)
	spOutput += "==EOF==<b>Spellbook:</b>  ";

if ((cl==4) || (cl==3))
	spOutput += "==EOF==<b>Current spells:</b> ";
...
if (ciSpells.length > 0) {
	spOutput += "==EOF==Druid Circle Spells: "; 
...
if (oaSpells.length > 0) {
	spOutput += "==EOF==Paladin Oath Spells: "; 
...
if (loSpells.length > 0) {
	spOutput += "==EOF==Bard Magical Secret Spells: "; 
...
if (doSpells.length > 0) {
	spOutput += "==EOF==Cleric Domain Spells: "; 
...
if (waTome.length > 0) {
	spOutput += "==EOF==<b>Warlock Tome Cantrips:</b> "; 
...
if (waSpells.length > 0) {
	spOutput += "==EOF==Spells Given by Invocations: "; 
...
if (ss1 > 0) {
	...
	spOutput += "==EOF==<b>Spell slots:</b>==EOF== " + ss1;
	if (cl != 14)  {
		spOutput += " first level";
	if (ss2 > 0) 
		spOutput += ",==EOF== " + ss2+ " second level";
	if (ss3 > 0) 
		spOutput += ",==EOF== " + ss3+ " third level";
	if (ss4 > 0) 
		spOutput += ",==EOF== " + ss4+ " fourth level";
	if (ss5 > 0) 
		spOutput += ",==EOF== " + ss5+ " fifth level";
	}
	if (cl==14) {
		if (level < 3)
			spOutput += " first level";
	...
	spOutput += "==EOF==<b>Spell save DC:</b>  " + (8 + prof + mod[spellAbility]) + "      <b>Spell Attack Modifier:</b>  " + showPlus (prof + mod[spellAbility]);


	if ((cl==3) || (cl==4) || (cl==15) || (cl==9))
		spOutput += "      ==EOF==Can prepare " + sp + " spells";
	

	if ((cl ==2) || (cl==5) || (cl==10) || (cl==12) || (cl==13) || (cl==14))
		spOutput += "      ==EOF==Knows " + sp + " spells";
...
weOutput += "==EOF==<b>Wealth:</b> " + gold + " gp";
if (platinum > 0) {
...
if (companion > -1) {
	...
	eqOutput += "==EOF==<b>Ranger's Companion:</b>  " + companions[companion] + " - " + (companionshp[companion] * 1) + " hit points, "+((companionsAC[companion] * 1)+ (prof*1)) + " AC, " + (companionsStats[companion]) + ((companionsAttack1[companion] * 1)+prof) + " to hit (" +(companionsDamage1[companion]) +"+"+(companionsDamageBonus[companion]+prof) + " dmg" +	companionsDamageExtra[companion] + ")";
...
if (familiar.length > 0)
	spOutput += "==EOF==<b>Pact of the Chain Familiar:</b>  " + familiar;
...
if ((familiar.length == 0) && ((mySpells.indexOf("Find Familiar") > -1) || (waTomeRituals.indexOf("Find Familiar") > -1))) {
	...
	spOutput += "==EOF==<b>Familiar:</b> " + familiars[x];
...
for (x=0;x < myWp.length;x++) {
	...
	if (wpRange[i] != 2) {
	   // if it's a finesse weapon and DEX is higher than STR then use dex bonus
		...
		if ((fiStyle==2) && (i != 12) && (i != 13) && (i != 20) && (wpNum[i] < 1))
			z=2;
		wpOutput += " (" + showPlus( mod[temp]+prof+y ) +  " to hit) " +wpDam[i]+ showPlus( mod[temp]+z+y ) + " " + wpType[i] + " damage==EOF==";	
	}	
	...
	if (wpRange[i] > 1) {
		...
		if ((i == 5) || (i == 6) || (i == 7)) {
			if ((fiStyle==0) || (cl==10)) 
				wrOutput += "   40 bolts==EOF==";
			else 
				wrOutput += "   20 bolts==EOF==";
			if (((magicArrowPlus > 0) && (magicArrowType.indexOf("olt") > -1)) && (magicArrowDisplay==false)) {
				wrOutput += "+" + magicArrowPlus + " " + magicArrowType +" (" + magicArrows + ") (" + showPlus( y+z+prof+q+magicArrowPlus ) +  " to hit) "+tempTxt+ showPlus( y+q+magicArrowPlus ) + " " + wpType[i] + " damage";
		...
		if ((i == 8) || (i == 9)) {
			if ((fiStyle==0) || (cl==10)) 
				wrOutput += "   40 arrows==EOF==";
			else 
				wrOutput += "   20 arrows==EOF==";
...
if (wrOutput.length >0)
	wpOutput += "<b>Ranged weapons:</b>  ==EOF==" + wrOutput;
...
arOutput+= "<b>Hit points:</b> " + hp + "   <b>Hit dice:</b>  " + level + "d" + hd +"==EOF==<b>Armor:</b>  ";
...
if (toOutput != "") {
	...
	abOutput =  "==EOF==<b>Other proficiencies:</b>" + toOutput + "==EOF==" + abOutput;
} else {
	abOutput =  "==EOF=="+ abOutput;
}
...
if ((spOutput.length == 0) && (raceSpells.length == 0)) {
	magicGet("spellspot",possibile).style.display="none";
} else {
	magicGet("spellspot",possibile).style.display="block";
}
...
showAbil();
if (al==true) {
	output  +=   "Faction:  " + factions[myFaction] + "   Lifestyle:  " + lifestyles[myLifestyle];
}

var GRECHINA = '<pre>------</pre>'
...
res+=(""+abOutput);
res+=(""+wpOutput);
if(wpOutput.slice(-7)!="==EOF=="){
	res+=("==EOF==");
}
res+=(""+arOutput);
res+=("<b>Language:</b> "+languageOutput+"==EOF==");
res+=GRECHINA+"==EOF=="
res+=(""+bgOutput);
res+="==EOF=="+GRECHINA+"==EOF==<b>Items:</b>==EOF=="
res+=(""+eqOutput);
res+=(""+spOutput);
